...
; (declare-const m1 (Map Int Int) (Map_default 0))
; (declare-const name sort value)

(constraint
  (forall ((v Int) (m1 (Map Int Int)))
    (=> (&& (= v (Map_select m1 100)) (= m1 (Map_default 0)))
        (= v 0))))

(constraint
  (forall ((v Int) (m1 (Map Int Int)) (m2 (Map Int Int)))
...
(constraint
  (forall ((v Int) (m1 (Map Int Int)) (m2 (Map Int Int)) (m3 (Map Int Int)))
...
; (constraint
;   (forall ((v Int) (m1 (Map Int Int)) (m2 (Map Int Int)) (m3 (Map Int Int)) (m4 (Map Int Int)) (m5 (Map Int Int)))
;     (=> (&& (= m1 (Map_default 0)) (&& (= m2 (Map_store (Map_store m1 10 1) 20 1))
;           (&& (= m3 (Map_store (Map_store m1 20 1) 10 1))
